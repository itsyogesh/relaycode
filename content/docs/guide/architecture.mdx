...
- **Base UI** (`components/ui/`) — [shadcn/ui](https://ui.shadcn.com/) components providing consistent styling and behavior. These are generated via `npx shadcn-ui add <component>` and should not be modified directly.
...
![Dual-pane builder interface](/docs/bidirectional-editing.gif)
