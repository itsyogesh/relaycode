...
description: Learn how to build your first extrinsic with Relaycode.
---
...
![Bidirectional editing in action](/docs/bidirectional-editing.gif)
...
- [Architecture](/docs/guide/architecture) - Understand how Relaycode is built
- [API Reference](/docs/api/input-map) - Learn about the type resolution system
- [Codec API](/docs/api/codec) - Understand encoding and decoding
